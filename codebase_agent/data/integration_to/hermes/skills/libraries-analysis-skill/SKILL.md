...
1. For each dependency library, break the analysis task down into research subtasks by dividing the overall investigation into individual topics.
   ...
   1. For each subtask, spawn subagen and delegate analysis job to it; subagent must perform the following:
      ...
      4. Respond detailed result of an analysis to the main session.
